...
function StatCard({ label, value, sublabel, tone = "gray", onClick }) {
  const tones = {
  ...
  return (
    <Comp
      ...
      className={cx(
        ...
        onClick ? "hover:opacity-95 cursor-pointer" : ""
      )}
    >
      ...
      {sublabel ? <div className="mt-1 text-xs opacity-80">{sublabel}</div> : null}
    </Comp>
  );
}
          ...
          <div className="px-6 py-5 border-b border-gray-200 bg-white">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div>
                ...
                <h1 className="mt-1 text-3xl font-extrabold text-[var(--color-wrcBlack)]">
                  My Leads
                </h1>
              ...
              <div className="w-full lg:w-[360px]">
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-black/10"
                />
            ...
            <div className="mt-5 h-2 w-full rounded-full bg-[#fff200]" />
          </div>
          ...
          <div className="px-6 py-5">
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <StatCard
                ...
                value={stats.overdue}
                tone="rose"
                sublabel="Past due follow-ups"
              />
              <StatCard
                label="Due next 7 days"
                value={stats.dueSoon}
                tone="amber"
                sublabel="Upcoming follow-ups"
              />
              <StatCard
                label="No due date"
                value={stats.noDueDate}
                sublabel="Needs admin due date"
              />
            </div>

            {loading ? (
              <div className="mt-4 text-sm text-gray-500">Loading your leads...</div>
            ) : null}
          ...
          <section className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="px-6 py-8">
              ...
              <div className="mt-2 text-sm text-gray-500">
                Try searching by name, email, phone, status, or next action item.
              </div>
            </div>
          </section>
        ) : null}
        ...
        {filteredLeads.length > 0 ? (
          <section className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200 bg-white">
              <h2 className="text-xl font-extrabold text-[var(--color-wrcBlack)]">
                Assigned leads
              </h2>
            </div>
...
function VirtualLeadGrid({ leads, onOpenLead }) {
  ...
  const headerCell =
    "px-3 py-3 text-[11px] uppercase tracking-wide text-gray-500 border-b border-gray-200 bg-gray-50 font-bold";
  const cellBase = "px-3 py-3 text-[11px] border-b border-gray-100";

  return (
    <div className="max-h-[70vh] overflow-auto" ref={scrollerRef} style={{ position: "relative" }}>
      <div style={{ minWidth: MIN_TABLE_W }}>
        <div className="sticky top-0 z-30" style={{ display: "grid", gridTemplateColumns: gridTemplate }}>
          <div className={`${headerCell} sticky left-0 z-40 bg-gray-50`} style={{ width: COL.name }}>
            Name
          </div>
          <div className={`${headerCell} sticky z-40 bg-gray-50`} style={{ left: COL.name, width: COL.contact }}>
            Contact
          </div>
        ...
        <div style={{ height: totalSize, position: "relative" }}>
          {virtualItems.map((vi) => {
            ...
            return (
              ...
              >
                <div className={`${cellBase} sticky left-0 z-20 bg-white group-hover:bg-gray-50`} style={{ width: COL.name }}>
                ...
                <div
                  className={`${cellBase} sticky z-20 bg-white group-hover:bg-gray-50`}
                ...
                <div className={cellBase}>
                  {(() => {
                    ...
                    if (!text) {
                      return <span className="text-gray-400 italic">No next action yet</span>;
                    }
